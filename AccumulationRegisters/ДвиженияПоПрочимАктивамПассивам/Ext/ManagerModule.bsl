...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет измерение ""Аналитика"" предопределенным значением ""Резерв ежегодных отпусков"" справочника ""Резервы""
		...
		|en = 'Fills the ""Dimension"" dimension with the predefined ""Annual leave reserve"" value of the ""Reserves"" catalog
		|in register records with the ""Item"" dimension value set to ""Remuneration provisions"" or ""Insurance contribution provisions"".'");
