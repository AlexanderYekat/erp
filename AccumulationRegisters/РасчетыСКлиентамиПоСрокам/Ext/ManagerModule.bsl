...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Refills the business transaction for the ""AR/AP offset"" document with the ""Debt transfer"" transaction kind.
	|Changes the ""Debt repayment"" business transaction to ""Move advance payment"" for payment offset records with the payment date period.'");
