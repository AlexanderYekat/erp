...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ТекстВопроса = НСтр("ru = 'Обновить классификатор полномочий ФНС (МЧД 003) сейчас?';
						|en = 'Do you want to update the FTS authority classifier (machine-readable authorization letter 003) now?'");
...
Функция ОбновитьКлассификаторНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Синхронизация классификатора полномочий ФНС (МЧД 003).';
															|en = 'Synchronize the FTS authority classifier (machine-readable authorization letter 003).'");
