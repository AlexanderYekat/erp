...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ru = 'Не удалось заполнить классификатор полномочий ФНС (МЧД 003) по причине:';
								|en = 'Cannot fill the FTS authority classifier (machine-readable authorization letter 003). Reason:'") + Символы.ПС 
