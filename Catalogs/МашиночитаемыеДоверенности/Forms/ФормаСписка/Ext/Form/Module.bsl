...
Процедура ЗагрузитьИзФайла(Команда)
	...
	Если ЗначениеЗаполнено(РезультатАвторизации.Ошибка) Тогда
		...
		ТекстОшибки = НСтр("ru = 'Невозможно проверить доверенность в распределенном реестре.';
							|en = 'Невозможно проверить доверенность в распределенном реестре.'");
...
Процедура ПослеОтветаНаВопросОЗагрузкеДоверенности(Результат, Ошибка) Экспорт
	...
	|en = 'Файлы доверенностей (%1)|%1'"), "*.xml;*.p7s;*.sig;");
