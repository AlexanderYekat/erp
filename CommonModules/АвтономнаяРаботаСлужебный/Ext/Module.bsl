	...
	Исключение
		...
		Если ОбщегоНазначения.ЭтоОбъектСсылочногоТипа(МетаданныеЭлемента) Тогда
			Шаблон = НСтр("ru = 'Навигационная ссылка: %1';
							|en = 'Навигационная ссылка: %1'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИначеЕсли ОбщегоНазначения.ЭтоРегистр(МетаданныеЭлемента) Тогда
			Шаблон = НСтр("ru = 'Отбор: %1';
							|en = 'Отбор: %1'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		Шаблон = НСтр(
			"ru = 'Ошибка при записи элемента ""%1"" при создании начального образа
		     ...
		     |en = 'Ошибка при записи элемента ""%1"" при создании начального образа
		     |%2 
		     |Подробности см. в журнале регистрации.'",
			ОбщегоНазначения.КодОсновногоЯзыка());
