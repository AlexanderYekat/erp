	...
	Если НайденныеСтроки.Количество() = 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Не найден вид приложения по имени ""%1""';
				|en = 'Не найден вид приложения по имени ""%1""'"), Имя);
	ИначеЕсли НайденныеСтроки.Количество() > 1 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Найдено несколько видов приложений по имени ""%1""';
				|en = 'Найдено несколько видов приложений по имени ""%1""'"), Имя);
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ТекстСообщения) Тогда
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Виды приложений. Поиск вида приложения';
				|en = 'Виды приложений. Поиск вида приложения'", ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	Для Каждого Услуга Из Услуги Цикл
		Результат = Результат + Разделитель + СтрШаблон(
			НСтр("ru = 'идентификатор поставщика: %1, идентификатор услуги: %2';
				|en = 'идентификатор поставщика: %1, идентификатор услуги: %2'"),
