...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Какие сводные данные о стоимости и амортизации основных средств в бухгалтерском учете?';
									|en = 'Check summary data on the cost and depreciation of fixed assets in accounting.'");
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Какие сводные данные о стоимости и амортизации НМА и расходов на НИОКР в бухгалтерском учете?';
									|en = 'Check summary data on the cost and depreciation of intangible assets and R&D expenses in accounting.'");
...
Функция СформироватьТаблицуВтПорцияДанныхКРасчету(НачалоПериода, МенеджерВременныхТаблиц, РазмерПорцииДанных = 100) Экспорт
...
Процедура СформироватьТаблицуВтДанныеКРасчету(МенеджерВременныхТаблиц) Экспорт
	...
	|				И НЕ УзлыКомпонентыАмортизации.УзелКомпонент.УчитыватьСтоимостьЛиквидационногоОбязательства
	|				И УзлыКомпонентыАмортизации.Активность
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
