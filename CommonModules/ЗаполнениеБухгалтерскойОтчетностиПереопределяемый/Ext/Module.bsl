...
#Область Строка1150
	...
	Если ПараметрыЗаполнения.ИсключитьМОБ Тогда
		ДополнитьАлгоритмы(Алгоритмы, Составляющая("+ МОП_ОБ 02.ЦФ, 84"), "11501", "1150");
		ДополнитьАлгоритмы(Алгоритмы, Составляющая("- МОП_ОБ 84, 02.ЦФ"), "11501", "1150");
	КонецЕсли;
#КонецОбласти
