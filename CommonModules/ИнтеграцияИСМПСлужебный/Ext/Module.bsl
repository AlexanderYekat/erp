...
Функция КатегорииОпераций() Экспорт
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Передача сведений о выводе из оборота продукции при порче или учере товара';
			|en = 'Передача сведений о выводе из оборота продукции при порче или учере товара'"));
	ПередачаДанных.Вставить(
	...
	ПередачаДанных.Вставить(
		...
		НСтр("ru = 'Передача сведений о возврате товара, выведенного из оборота для собственных нужд';
			|en = 'Передача сведений о возврате товара, выведенного из оборота для собственных нужд'"));
	ПередачаДанных.Вставить(
