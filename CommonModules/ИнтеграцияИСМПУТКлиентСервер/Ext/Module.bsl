...
Процедура КомандыМаркировкиТоваровИСМП(Команды) Экспорт 
	...
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды, "ПроизводственнаяОперацияВЕТИС", НСтр("ru = 'Производственная операция ВетИС';
																											|en = 'VetIS production operation'"), "ВестиУчетПодконтрольныхТоваровВЕТИС");
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды, "ВходящаяТранспортнаяОперацияВЕТИС", НСтр("ru = 'Входящая транспортная операция ВетИС';
																												|en = 'Incoming VetIS transport operation'"), "ВестиУчетПодконтрольныхТоваровВЕТИС");
...
Процедура КомандыВозвратаВОборотИСМП(Команды) Экспорт 
	...
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды, "КорректировкаРеализации",  НСтр("ru = 'Корректировку реализации';
																										|en = 'Корректировку реализации'"),    "ИспользоватьКорректировкиРеализаций");
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды, "ОтчетОРозничныхВозвратах", НСтр("ru = 'Отчет о розничных возвратах';
																										|en = 'Отчет о розничных возвратах'"), "ИспользоватьРозничныеПродажи");
