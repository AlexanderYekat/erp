...
Функция ИмяКлассаСущности(Операция) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутреняя ошибка. Не обработана операция получения имени класса сущности %1';
										|en = 'Внутреняя ошибка. Не обработана операция получения имени класса сущности %1'"), Операция);
...
Функция ИмяОперации(Операция) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутреняя ошибка. Не обработано имя операции %1';
										|en = 'Внутреняя ошибка. Не обработано имя операции %1'"), Операция);
...
Функция СпособПримененияПАТ(СпособПрименения) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутреняя ошибка. Неизвестный способ применения ПАТ %1';
										|en = 'Внутреняя ошибка. Неизвестный способ применения ПАТ %1'"), СпособПрименения);
...
Функция ТипМестаПрименения(Значение) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Внутреняя ошибка. Неизвестный тип места применения %1';
										|en = 'Внутреняя ошибка. Неизвестный тип места применения %1'"), Значение);
