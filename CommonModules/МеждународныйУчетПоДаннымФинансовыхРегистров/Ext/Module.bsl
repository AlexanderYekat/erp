...
Функция ТаблицаЗапросаАналитики(РезультатЗапроса)
	...
	ОбязательныеПоляИндекса = "Период,Регистратор,ИдентификаторФинЗаписи,ИдентификаторСтроки,ИмяРегистра,ОбъектУчета,ОбъектНастройки,ДатаПогашения,Организация";
