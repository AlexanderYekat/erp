...
Функция ШаблонУведомленияОбИспользованииПЭП_УНЭП(ПараметрыЗаполнения) Экспорт
	...
	Исключение
		ТекстОшибки = НСтр("ru = 'Не удалось заполнить значения параметров шаблона положения об использовании простой ЭП причине:';
							|en = 'Не удалось заполнить значения параметров шаблона положения об использовании простой ЭП причине:'")
...
Функция ШаблонПоложенияОбИспользованииПЭП_УНЭП(Параметры) Экспорт
	...
	Исключение
		ТекстОшибки = НСтр("ru = 'Не удалось заполнить значения параметров шаблона положения об использовании простой ЭП причине:';
							|en = 'Не удалось заполнить значения параметров шаблона положения об использовании простой ЭП причине:'") + Символы.ПС + ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		ВызватьИсключение ТекстОшибки;
	КонецПопытки;
