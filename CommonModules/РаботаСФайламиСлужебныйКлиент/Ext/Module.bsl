...
Функция ПодключенныеУстройства(Форма, ПодключаемыйМодуль)
	...
	Исключение   
		...
		ПоказатьОшибкуСканирования(ПодключаемыйМодуль, Форма, НСтр("ru = 'Не удалось получить список устройств';
...
Функция НастройкаСканера(Форма, ПодключаемыйМодуль, ИмяУстройства, ИмяНастройки) Экспорт
	...
	Исключение
		...
		ПоказатьОшибкуСканирования(ПодключаемыйМодуль, Форма, НСтр("ru = 'Не удалось получить настройки устройства.';
...
Функция ЕстьУстройства(Форма, ПодключаемыйМодуль, ПоказыватьОшибку = Истина) Экспорт
	...
	Исключение
		...
		Если ПоказыватьОшибку Тогда
			ПоказатьОшибкуСканирования(ПодключаемыйМодуль, Форма, НСтр("ru = 'Не удалось проверить наличие устройств';
...
Процедура НачатьСканирование(Форма, ПодключаемыйМодуль, ПараметрыСканирования) Экспорт
	...
	Исключение
		...
		ПоказатьОшибкуСканирования(ПодключаемыйМодуль, Форма, НСтр("ru = 'Не удалось отсканировать документ';
	...
	Если Не Результат.Успешно Тогда
		...
		ЗаписатьЖурналСканирования("ФайлКомпоненты", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Каталог журнала сканирования недоступен %1. Использование каталога отменено.';
				|en = 'The scan log directory is unavailable %1. Directory usage is cancelled.'"), ВнешнийКонтекст.КаталогЖурналаСканирования), Истина);
...
#Если Не ВебКлиент Тогда	
	...
	Текст =  НСтр("ru = 'Информация о компьютере:';
					|en = 'Computer information:'") + Символы.ПС;
	...
	Текст = Текст + НСтр("ru = 'Операционная система:';
