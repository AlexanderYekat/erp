...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеПриемкиИПриемкиТоваровНаХранение(АктОРасхождениях, Основание, СтруктураВозврата, ИзменениеДокумента)
	...
	|			ТОГДА НЕОПРЕДЕЛЕНО
//++ НЕ УТКА
	|		КОГДА АктОРасхожденияхПослеПриемкиТовары.ЗаказПоставщику = ЗНАЧЕНИЕ(Документ.ЗаказДавальца2_5.ПустаяСсылка)
	|			ТОГДА НЕОПРЕДЕЛЕНО
//-- НЕ УТКА
	|		ИНАЧЕ АктОРасхожденияхПослеПриемкиТовары.ЗаказПоставщику
	|	КОНЕЦ                                                                   КАК ЗаказПоставщику,
	...
	|			ТОГДА НЕОПРЕДЕЛЕНО
//++ НЕ УТКА
	|		КОГДА ПриемкаТоваровНаХранениеТовары.ЗаказПоставщику = ЗНАЧЕНИЕ(Документ.ЗаказДавальца2_5.ПустаяСсылка)
	|			ТОГДА НЕОПРЕДЕЛЕНО
//-- НЕ УТКА
