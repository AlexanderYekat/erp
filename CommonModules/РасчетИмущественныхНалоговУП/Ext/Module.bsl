...
Процедура СформироватьТаблицуРегистрацияТранспортныхСредствСрезПоследних(ПараметрыРасчета, Период, ДополнительныеПараметры, ИмяТаблицы = "") Экспорт
	...
	// 	Первая с преиодом равным дате начала действия исправления и указанной датой исправления.
	// 	Вторая с преиодом равным дате исправления и пустой датой исправления.
