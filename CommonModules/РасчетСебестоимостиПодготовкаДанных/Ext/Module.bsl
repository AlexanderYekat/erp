...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(39, НСтр("ru = 'Не заполнен документ поступления расходов в движениях документа ""Отражение прочих доходов и расходов"".';
											|en = 'The document of expenses in the document records ""Non-operating income and expenses"" is not filled.'"));
	...
	РасшифровкаКодовОшибок.Вставить(56, НСтр("ru = 'Не заполнен код строки в аналитике учета партии приходного документа';
											|en = 'A line code is not filled in Lot: vendor attributes of the receipt document'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
//-- НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Включение учета себестоимости';
											|en = 'Включение учета себестоимости'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
//-- НЕ УТКА
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Некорректные движения по документу ""Корректировка реализации"" в регистре ""Прочие расходы""';
											|en = 'Некорректные движения по документу ""Корректировка реализации"" в регистре ""Прочие расходы""'", ОбщегоНазначения.КодОсновногоЯзыка()));
