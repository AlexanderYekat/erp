...
#Область ДанныеОС
	...
	|			ДокументыАренды.СправедливаяСтоимостьРегл - ДокументыАренды.НГЛСРегл - ДокументыАренды.АвансовыеПлатежиРегл
	|		ИНАЧЕ
	|			СуммаРасходов.РасходыРегл - ДокументыАренды.НГЛСРегл - ДокументыАренды.АвансовыеПлатежиРегл
	...
	|		+ ЕСТЬNULL(СуммаРасходов.РасходыРегл, 0)
	|		- (ДокументыАренды.НГЛСРегл - ОстаткиИнвестицииВАренду.НГЛСРегл) КАК ПриведеннаяСтоимостьРегл
	|ИЗ
	|	ДокументыАренды КАК ДокументыАренды
