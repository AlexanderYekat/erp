...
Процедура РасчетМатериальнойВыгодыПоЗаймамСотрудников(Организация, ДатаПолученияДохода, РасчетЗаймов, Регистратор) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПериодыПогашенияЗайма.ДатаОкончания КАК Период
	...
	|	ЕстьNULL(СтавкаРефинансированияЦБСрезПоследних.Размер,&СтавкаНаДатуПолученияДоходаПоДокументу) КАК СтавкаРефинансирования
	|ИЗ
	...
	|		ПО Интервалы.ДатаОкончания = СтавкаРефинансированияЦБСрезПоследних.Период
	|
	|УПОРЯДОЧИТЬ ПО
...
Процедура УточнитьСторнируемыеПоНачислениям(ТаблицаСторнируемыхДокументов, ТаблицаПромежуточныхИсправлений, МенеджерВременныхТаблиц, ИмяВТ)
	...
	Если Зацикливания.Количество() Тогда
		...
		Для Каждого Строка Из Зацикливания Цикл
			...
			|en = 'Обнаружено зацикливание ссылкой на сторнируемый документ: %1
			|Следует пересчитать и перепровести документы в правильном порядке, или вручную отредактировать перерасчеты в документе.'");

			ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("Зацикливание", УровеньЖурналаРегистрации.Предупреждение,
		...
		НСтр("ru = 'Обнаружено зацикливание сторнируемых документов! Подробности см. в журнале регистрации (Предупреждение ""Зацикливание"")';
			|en = 'Обнаружено зацикливание сторнируемых документов! Подробности см. в журнале регистрации (Предупреждение ""Зацикливание"")'");
	КонецЕсли;
