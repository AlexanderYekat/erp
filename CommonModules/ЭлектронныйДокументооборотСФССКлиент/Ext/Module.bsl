...
Функция ЭтоФайлPDF(ДанныеФайла) Экспорт
	...
	Если Позиция1 = 0 ИЛИ Позиция2 = 0 Тогда
		ТекстОшибки = НСтр("ru = 'Открыть файл требования невозможно. С сервера СФР получен некорректный файл pdf.';
							|en = 'Открыть файл требования невозможно. С сервера СФР получен некорректный файл pdf.'");
		ИмяСобытия = НСтр("ru = 'Электронный документооборот с контролирующими органами. Открытие файла вложения требования СФР';
							|en = 'Электронный документооборот с контролирующими органами. Открытие файла вложения требования СФР'");
