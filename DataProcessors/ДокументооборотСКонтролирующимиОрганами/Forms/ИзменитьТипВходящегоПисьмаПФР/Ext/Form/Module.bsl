...
Функция ПредставлениеПисьма(ТекущаяСсылка)
	...
	Результат = НСтр("ru = 'письмо';
					|en = 'email'") + " " + ВсеРеквизиты.Наименование + " "
				+ НСтр("ru = 'от';
						|en = 'dated'") + " " + ВсеРеквизиты.Отправитель + " "
				+ НСтр("ru = 'для';
						|en = 'for'") + " " + ВсеРеквизиты.Получатель + " "
				+ НСтр("ru = 'за';
						|en = 'for'") + " " + Формат(ВсеРеквизиты.ДатаСообщения, "ДФ=dd.MM.yy");
		...
		Исключение
			...
			ТекстОшибки = СтрШаблон(
				НСтр("ru = 'Ошибка при записи цикла обмена: %1';
					|en = 'An error occurred while writing the exchange cycle: %1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Электронный документооборот с контролирующими органами. Цикл обмена';
					|en = 'Electronic data interchange with regulatory authorities. Exchange cycle'",
