...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДокументооборотСКОКлиентСервер.ПодсистемаЦБСуществует() Тогда
		ЗаголовокФормы = НСтр("ru = 'Настройки обмена с ФНС, Росстатом, ПФР и Банком России';
								|en = 'Set up exchange with FTS, Russian Federal State Statistics Service, PF, and Bank of Russia'");
	Иначе
		ЗаголовокФормы = НСтр("ru = 'Настройки обмена с ФНС, Росстатом и ПФР';
								|en = 'Set up exchange with FTS, Russian Federal State Statistics Server, and Social Insurance Fund of Russia'");
	КонецЕсли;
