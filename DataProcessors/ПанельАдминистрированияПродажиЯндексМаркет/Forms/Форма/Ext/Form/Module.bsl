...
Процедура ДобавитьИзменитьЭлементыФормыАккаунт(Знач Аккаунт)
	...
	Элементы["ПоказатьСтатусАвторизации_" + ИдентификаторАккаунта].Заголовок    = ?(Аккаунт.ТребуетсяАвторизация, НСтр("ru = 'Требуется авторизация';
																														|en = 'Authorization is required'"), НСтр("ru = 'Состояние авторизации';
																																							|en = 'Authorization state'"));
