...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ШаблонКомментарияОбработчика = НСтр("ru = 'Проверка/исправление значения реквизита %1 в табличной части %2 документа %3. Значение 9 будет заменено на 10, если серии корректно указаны в отдельной табличной части.';
										|en = 'Проверка/исправление значения реквизита %1 в табличной части %2 документа %3. Значение 9 будет заменено на 10, если серии корректно указаны в отдельной табличной части.'");
