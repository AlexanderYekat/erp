			...
			Если СтрокиДокумента.Количество = 1 Тогда
				...
				СтрШаблон(
					НСтр("ru = 'В строке %1 недостаточно остатков для формирования партии. Доступный остаток %2, к оформлению %3';
						|en = 'В строке %1 недостаточно остатков для формирования партии. Доступный остаток %2, к оформлению %3'"),
					...
					ИнтеграцияЗЕРНОКлиентСервер.ДобавитьТекстОшибки(
						...
						СтрШаблон(
							НСтр("ru = 'В строке %1 недостаточно остатков для формирования партии. Доступный остаток %2, к оформлению %3 в строках %4';
								|en = 'В строке %1 недостаточно остатков для формирования партии. Доступный остаток %2, к оформлению %3 в строках %4'"),
		...
		Для Каждого СтрокаПартии Из СтрокиДокумента Цикл
			...
			Иначе
				...
				Если ЗначениеЗаполнено(СтрокаПартии.Товаропроизводитель) Тогда
					...
					ПредставлениеИсточника = СтрШаблон(НСтр("ru = 'Производитель партии %1';
															|en = 'Производитель партии %1'"), СтрокаПартии.ТоваропроизводительПредставление);
				Иначе
					Производитель = СтрокаПартии.Организация;
					ПредставлениеИсточника = СтрШаблон(НСтр("ru = 'Производитель партии %1';
															|en = 'Производитель партии %1'"), Шапка.ОрганизацияПредставление);
				КонецЕсли;
					...
					ИнтеграцияЗЕРНОКлиентСервер.ДобавитьТекстОшибки(
						...
						СтрШаблон(
							НСтр("ru = 'В строке %1 для производителя партии %2';
								|en = 'В строке %1 для производителя партии %2'"),
							СтрокаПартии.НомерСтроки,
