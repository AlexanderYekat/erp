...
Процедура ТекстЗапросаТаблицаПервоначальныеСведенияНМА(Запрос, ТекстыЗапроса, Регистры)
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаВтТаблицаПереоценки(Запрос, ТекстыЗапроса, "НМА", "Документ.ПереоценкаНМА2_4");
	...
	|		ПО УчетнаяПолитикаФинансовогоУчета.Организация = ДанныеДокумента.ГоловнаяОрганизация
	|ГДЕ
