...
Процедура ЗаполнитьРеквизитыПравКонтроля()
	...
	ПравоКонтрольВыполненияОпераций = РольДоступна("ПолныеПрава")
			ИЛИ РольДоступна("КонтрольВыполненияОпераций");
			
	ПравоСамостоятельныйКонтрольВыполненныхОпераций = РольДоступна("ПолныеПрава")
			ИЛИ ОперативныйУчетПроизводства.ЕстьПравоСамостоятельногоКонтроляОперации(
