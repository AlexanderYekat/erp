...
Функция ТекстЗапросаВтТовары(Запрос, ТекстыЗапроса)
	...
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ                                               КАК ОтправительАналитикаУчетаНоменклатуры,
	|	ВЫБОР
	...
	|
	|	ТаблицаТовары.АналитикаУчетаНоменклатуры            КАК ПолучательАналитикаУчетаНоменклатуры,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательНоменклатура,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательХарактеристика,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательСерия,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательМестоХранения,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательНазначение,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательСтатьяКалькуляции,
	|
	...
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ                                               КАК ОтправительАналитикаУчетаНоменклатуры,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительНоменклатура,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительХарактеристика,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительСерия,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительМестоХранения,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительНазначение,
	|	НЕОПРЕДЕЛЕНО                                        КАК ОтправительСтатьяКалькуляции,
	|
	|	ТаблицаТовары.АналитикаУчетаНоменклатуры            КАК ПолучательАналитикаУчетаНоменклатуры,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательНоменклатура,
	|	НЕОПРЕДЕЛЕНО                                        КАК ПолучательХарактеристика,
	...
	|	КОНЕЦ                                                   КАК ОтправительСтатьяКалькуляции,
	|
	|	НЕОПРЕДЕЛЕНО                                                   КАК ПолучательАналитикаУчетаНоменклатуры,
	...
	|
	|	ТаблицаТовары.АналитикаУчетаНоменклатуры                КАК ОтправительАналитикаУчетаНоменклатуры,
	|	НЕОПРЕДЕЛЕНО                                            КАК ОтправительНоменклатура,
	|	НЕОПРЕДЕЛЕНО                                            КАК ОтправительХарактеристика,
	|	НЕОПРЕДЕЛЕНО                                            КАК ОтправительСерия,
	|	НЕОПРЕДЕЛЕНО                                            КАК ОтправительМестоХранения,
...
Функция ТекстЗапросаВтВидыЗапасов(Запрос, ТекстыЗапроса)
	...
	//-- НЕ УТКА
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ОтправительАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ОтправительАналитикаУчетаНоменклатуры
	...
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ОтправительАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			ТОГДА КлючиНоменклатурыПоКлючуОтправителяБезНазначения.КлючАналитики
	|		КОГДА НЕ втТовары.ОтправительНоменклатура = НЕОПРЕДЕЛЕНО
	...
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ПолучательАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ПолучательАналитикаУчетаНоменклатуры
	...
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ПолучательАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			ТОГДА КлючиНоменклатурыПоКлючуПолучателяБезНазначения.КлючАналитики
	|		КОГДА НЕ втТовары.ПолучательНоменклатура = НЕОПРЕДЕЛЕНО
	...
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ОтправительНоменклатура = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ОтправительМестоХранения
	|		ИНАЧЕ втТовары.ОтправительАналитикаУчетаНоменклатуры.МестоХранения
	|	КОНЕЦ														КАК Склад,
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ПолучательНоменклатура = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ПолучательМестоХранения
	|		ИНАЧЕ втТовары.ПолучательАналитикаУчетаНоменклатуры.МестоХранения
	|	КОНЕЦ														КАК Получатель,
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ПолучательНоменклатура = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ПолучательНоменклатура
	|		ИНАЧЕ втТовары.ПолучательАналитикаУчетаНоменклатуры.Номенклатура
	|	КОНЕЦ														КАК Номенклатура,
	|	ВЫБОР
	|		КОГДА НЕ втТовары.ПолучательНоменклатура = НЕОПРЕДЕЛЕНО
	|			ТОГДА втТовары.ПолучательХарактеристика
	|		ИНАЧЕ втТовары.ПолучательАналитикаУчетаНоменклатуры.Характеристика
	...
	|		КОГДА втТовары.ИсточникАналитикаФинансовогоУчета = ""Номенклатура""
	|			И &АналитическийУчетПоГруппамПродукции
	|			И НЕ втТовары.ОтправительАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			И НЕ втТовары.ОтправительАналитикаУчетаНоменклатуры.Номенклатура.ГруппаАналитическогоУчета = ЗНАЧЕНИЕ(Справочник.ГруппыАналитическогоУчетаНоменклатуры.ПустаяСсылка)
	|			ТОГДА втТовары.ОтправительАналитикаУчетаНоменклатуры.Номенклатура.ГруппаАналитическогоУчета
	|		КОГДА втТовары.ИсточникАналитикаФинансовогоУчета = ""Номенклатура""
	|			И &АналитическийУчетПоГруппамПродукции
	...
	|		КОГДА втТовары.ИсточникАналитикаФинансовогоУчета = ""Номенклатура""
	|			И &АналитическийУчетПоГруппамПродукции
	|			И НЕ втТовары.ПолучательАналитикаУчетаНоменклатуры = НЕОПРЕДЕЛЕНО
	|			И НЕ втТовары.ПолучательАналитикаУчетаНоменклатуры.Номенклатура.ГруппаАналитическогоУчета = ЗНАЧЕНИЕ(Справочник.ГруппыАналитическогоУчетаНоменклатуры.ПустаяСсылка)
	|			ТОГДА втТовары.ПолучательАналитикаУчетаНоменклатуры.Номенклатура.ГруппаАналитическогоУчета
	...
	|		КОГДА втТовары.ИсточникВидДеятельностиНДС = ""НазначениеПолучателя""
	|			И ЕСТЬNULL(втТовары.ПолучательАналитикаУчетаНоменклатуры.Назначение.ВидДеятельностиНДС, ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)) <>
	|				ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)
	|			ТОГДА втТовары.ПолучательАналитикаУчетаНоменклатуры.Назначение.ВидДеятельностиНДС
	...
	|		КОГДА втТовары.ИсточникВидДеятельностиНДС = ""НазначениеОтправителя""
	|			И ЕСТЬNULL(втТовары.ОтправительАналитикаУчетаНоменклатуры.Назначение.ВидДеятельностиНДС, ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)) <>
	|				ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)
	|			ТОГДА втТовары.ОтправительАналитикаУчетаНоменклатуры.Назначение.ВидДеятельностиНДС
	|		КОГДА втТовары.ИсточникВидДеятельностиНДС = ""НазначениеПолучателя""
	...
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаНоменклатуры КАК КлючиНоменклатурыПоКлючуОтправителяБезНазначения
	|	ПО КлючиНоменклатурыПоКлючуОтправителяБезНазначения.Номенклатура = втТовары.ОтправительАналитикаУчетаНоменклатуры.Номенклатура
	|	И КлючиНоменклатурыПоКлючуОтправителяБезНазначения.Характеристика = втТовары.ОтправительАналитикаУчетаНоменклатуры.Характеристика
	|	И КлючиНоменклатурыПоКлючуОтправителяБезНазначения.Серия = втТовары.ОтправительАналитикаУчетаНоменклатуры.Серия
	|	И КлючиНоменклатурыПоКлючуОтправителяБезНазначения.МестоХранения = втТовары.ОтправительАналитикаУчетаНоменклатуры.МестоХранения
	|	И КлючиНоменклатурыПоКлючуОтправителяБезНазначения.Назначение = ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка)
	|	И КлючиНоменклатурыПоКлючуОтправителяБезНазначения.СтатьяКалькуляции = втТовары.ОтправительАналитикаУчетаНоменклатуры.СтатьяКалькуляции
	|	
	...
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаНоменклатуры КАК КлючиНоменклатурыПоКлючуПолучателяБезНазначения
	|	ПО КлючиНоменклатурыПоКлючуПолучателяБезНазначения.Номенклатура = втТовары.ПолучательАналитикаУчетаНоменклатуры.Номенклатура
	|	И КлючиНоменклатурыПоКлючуПолучателяБезНазначения.Характеристика = втТовары.ПолучательАналитикаУчетаНоменклатуры.Характеристика
	|	И КлючиНоменклатурыПоКлючуПолучателяБезНазначения.Серия = втТовары.ПолучательАналитикаУчетаНоменклатуры.Серия
	|	И КлючиНоменклатурыПоКлючуПолучателяБезНазначения.МестоХранения = втТовары.ПолучательАналитикаУчетаНоменклатуры.МестоХранения
	|	И КлючиНоменклатурыПоКлючуПолучателяБезНазначения.Назначение = ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка)
	|	И КлючиНоменклатурыПоКлючуПолучателяБезНазначения.СтатьяКалькуляции = втТовары.ПолучательАналитикаУчетаНоменклатуры.СтатьяКалькуляции
	|	
