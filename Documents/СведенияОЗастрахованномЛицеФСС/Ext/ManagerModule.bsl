...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление  = СтрШаблон(НСтр("ru = '%1 (до %2)';
													|en = '%1 (till %2)'"), Макет.Представление(), Формат(ДатаФорм2022 - 1, "ДЛФ=D"));
...
Функция ЗаголовокФормыОтправкиСведенийВФСС() Экспорт
	Возврат НСтр("ru = 'Отправка сведений о застрахованных лицах в ФСС через СЭДО';
				|en = 'Sending of insured person details to SSF via EDI'");
КонецФункции
