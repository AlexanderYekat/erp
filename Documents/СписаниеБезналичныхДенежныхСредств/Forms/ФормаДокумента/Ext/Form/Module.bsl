...
Процедура РасшифровкаПлатежаДоговорАрендыПриИзменении(Элемент)
	...
	ЗаполнитьРеквизитыПлатежаПоДоговоруАренды(СтрокаТаблицы.ДоговорАренды);
...
&НаСервере
Процедура ЗаполнитьРеквизитыПлатежаПоДоговоруАренды(ДоговорАренды)

	СписокДоговоров = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ДоговорАренды);
	ТаблицаДанных = ДанныеПоДоговорамАренды(СписокДоговоров);
	НайденнаяСтрока = ТаблицаДанных.Найти(ДоговорАренды, "ДоговорАренды");
