	...
	Если ВидОрганизации = "0" Тогда
		...
		Если НЕ ДокументооборотСКОКлиентСервер.ПроверитьРегистрационныйНомерПФР(РегистрационныйНомерПФР, Истина) Тогда
			ТекстСообщенияПользователю = ДокументооборотСКОКлиентСервер.ЗаменитьПФРиФССнаСФР(
				НСтр("ru = 'Регистрационный номер ПФР должен состоять из 12 цифр (ХХХ-ХХХ-ХХХХХХ)';
					|en = 'Регистрационный номер ПФР должен состоять из 12 цифр (ХХХ-ХХХ-ХХХХХХ)'"), Истина);
