	...
	Если СтатусОперации = ОблачныеКассыКлиентСервер.СтатусОперацииВыполнена()
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Запрещено обновление статуса чека с незаполненными терминальными данными.
				|Документ операции: %1
				|Тип данных: %2';
				|en = 'Запрещено обновление статуса чека с незаполненными терминальными данными.
				|Документ операции: %1
				|Тип данных: %2'",
	...
	Попытка
		...
		Если Набор.Количество() = 0 Тогда
			ВызватьИсключение НСтр("ru = 'Не найдена информация о данных операции с Облачной кассы.
				...
				|en = 'Не найдена информация о данных операции с Облачной кассы.
				|Невозможно обновить информацию о пробитии чека.'",
				ОбщегоНазначения.КодОсновногоЯзыка());
		КонецЕсли;
	...
	Исключение
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Ошибка записи информации о пробитии чека.
				|%1';
				|en = 'Ошибка записи информации о пробитии чека.
				|%1'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	Исключение
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Ошибка увеличения количества попыток выполнить отложенную операцию Облачной кассы.
				|%1';
				|en = 'Ошибка увеличения количества попыток выполнить отложенную операцию Облачной кассы.
				|%1'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	...
	Исключение
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Ошибка изменения признака обработки данных операции Облачной кассой.
				|%1';
				|en = 'Ошибка изменения признака обработки данных операции Облачной кассой.
				|%1'",
				ОбщегоНазначения.КодОсновногоЯзыка()),
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
