	...
	Если Элемент = Элементы._ОснНарушПрав
		...
		Если СтрДлина(Элемент.ТекстРедактирования) > 2000 Тогда 
			ТекстСообщения = НСтр("ru = 'При выгрузке в электронном виде текст будет сокращен до 2000 символов.';
									|en = 'При выгрузке в электронном виде текст будет сокращен до 2000 символов.'")
				+ Символы.ПС + НСтр("ru = 'Рекомендуется сократить текст, полный текст можно приложить в приложенных файлах.';
									|en = 'Рекомендуется сократить текст, полный текст можно приложить в приложенных файлах.'");
