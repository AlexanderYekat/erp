...
Функция ЭтоОбластьОКСМ(Область)
	Возврат (Область.Имя = "СтрРег" И ТекущееИДНаименования = "СвЮЛ") 
		Или (Область.Имя = "КодСтр" И ТекущееИДНаименования = "СвСчет")
		Или (Область.Имя = "КодСтр" И ТекущееИДНаименования = "СвСчетДо");
КонецФункции
