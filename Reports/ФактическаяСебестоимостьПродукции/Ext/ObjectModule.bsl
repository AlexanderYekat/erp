...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Накладные = Неопределено;
		Для Каждого ЭлементПарметров Из НастройкиОтчета.ПараметрыДанных.Элементы Цикл
		Если ЭлементПарметров.Параметр = Новый ПараметрКомпоновкиДанных("Регистратор")
			И ЭлементПарметров.Использование Тогда
			
			Накладные = ЭлементПарметров.Значение;
		КонецЕсли;
	КонецЦикла;
